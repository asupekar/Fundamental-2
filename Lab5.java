 ...
 * displayed to the user in column form. Also the duplicates are removed from the list and then 
...
public class Lab5 {
	...
	private void printInfo() {
		System.out.println(
				"This program reads the file lab4.dat and inserts the elements into a linked list in nondescendin\ng order.\n"
						...
						+ "then removed, and the contents are dispayed again.");
	}
	...
	/**
	 * Adds a number from a file to the list in order. 3 possibilities: 1. Add at
	 * the beginning of the list 2. Add in the middle of the list 3. Add at the end
	 * of the list
	 * 
